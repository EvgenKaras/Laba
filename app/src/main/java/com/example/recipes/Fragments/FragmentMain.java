...
public class FragmentMain extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TableRow i =(TableRow) rootView.findViewById(R.id.mainIZB);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment yoursFragment=new FragmentInteresting();
        ...
        //обработчик нажатия на все рецепты
        TextView q =(TextView) rootView.findViewById(R.id.all_recipes);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment yoursFragment=new FragmentSearch();
                FragmentTransaction trans=getFragmentManager().beginTransaction();
                trans.replace(R.id.container, yoursFragment).addToBackStack(null);
                trans.commit();
            }
        ...
        //обработчик нажатия кнопки список покупок
        Button but =(Button) rootView.findViewById(R.id.buttonListShop);
        but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment yoursFragment=new FragmentShopping();
                FragmentTransaction trans=getFragmentManager().beginTransaction();
                trans.replace(R.id.container, yoursFragment).addToBackStack(null);
                trans.commit();
            }
