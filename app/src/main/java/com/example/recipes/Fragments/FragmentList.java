...
public class FragmentList extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //TableRow i =(TableRow) rootView.findViewById(R.id.first);
        //i.setOnClickListener(this);

        ListView ls = (ListView)rootView.findViewById(R.id.listRep);
        ...
        Realm.getDefaultInstance().executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                RealmResults<Recept> recepts = realm.where(Recept.class).findAll();

                for (Recept r:recepts)
                {
                    items.add(new Receptlistitem(r.getImgID(),r.getName(),r.getDescr(), r.getRating(),r.getId()));
                }
            }
        });
